  ...
  return (
    <section className="bg-white py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-[#fdd300] rounded-3xl overflow-hidden flex flex-col md:flex-row items-center relative shadow-md">
          <div className="p-8 sm:p-12 lg:p-16 md:w-1/2 w-full flex flex-col items-start z-10">
            ...
            <a 
              ...
              className="mt-8 inline-flex items-center gap-3 bg-[#0e52ff] hover:bg-[#0038c4] text-white font-bold text-base px-8 py-4 rounded-xl transition shadow-md hover:shadow-lg"
            >
